...
contract TestIntegrationSupply is IntegrationTest {
    ...
    function testShouldSupplyPoolOnly(uint256 seed, address onBehalf, uint256 amount) public {
        ...
        test.supplied = user.supplyAgg(market.underlying, onBehalf, amount); // 100% pool.
